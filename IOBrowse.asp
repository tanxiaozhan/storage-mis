...
<td width="700">
<form name="my" method="POST" action="IOBrowseTable.asp" target="_blank">
...
<input type="text" name="tbday" size="2" value=<% =bDay %>>日 至 <input type="text" name="teyear" size="4" value=<% =eYear %>>年<input type="text" name="temonth" size="2" value=<% =bMonth %>>月<input type="text" name="teday" size="2" value=<% =eDay %>>日<input type="submit" value="查看进出情况一览表" name="jy">        
</p>
</form>  
