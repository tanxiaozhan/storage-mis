      ...
      <table border="0" width="100%" height="31">
        <tr>
          <td width="25%" height="27" background="image/button3.gif">
            ...
            <img border="0" src="image/stargold.gif" width="14" height="18">填写进仓&nbsp;</b></font></td>                                                                      
 ...
 <td width="20%" height="27" background="image/button3.gif">
  ...
  <TR>
    <TD width="589" valign="top" height="57"> 
      <form name="InStoreForm" method="POST" action="InStore_Add.asp?Operate=Add">
        <hr color="#A3D0E9">
...
%>
        ...
        &nbsp;&nbsp;&nbsp;　　　<input type="checkbox" name="chkPrintInStoreTable" value="ON" maxlength="40"><font face="宋体" size="3">打印入库通知单</font>　　　　                                                                                                    
        <input type="button" value="进 仓" name="btOK" OnClick="ValidateData()" style="font-family: 宋体; font-size: 12pt; font-weight: bold" tabindex="20" maxlength="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                                                                                    
