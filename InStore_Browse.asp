...
<TABLE border=0 cellPadding=0 cellSpacing=0 height="1" width="952">
      ...
      <table border="0" height="28" width="655">
        <tr>
          ...
          <td width="167" height="24" background="image/button3.gif">
            ...
            <p align="center"><font face="宋体" size="3">
			<b><img border="0" src="image/stargold.gif" width="14" height="19">仓储浏览</b></font></td>                                                                                
          <td width="175" height="24" background="image/button3.gif">
            <p align="right"><font face="宋体" size="3"><b><a href="Print_InStore.asp">打印入库通知单</a></b></font></td>                                                                                
        </tr>
      </table>
      </td>
  </tr>
  ...
  <tr> 
    ...
    <td valign="bottom" height="1" width="690"> 
      ...
      <p style="margin-top: 1; margin-bottom: 1"><b><font size="2">客户名称:</font></b><font size="2">  
      ...
      <b>合同号:</b><input type="text" name="tContractID" size="10" onkeypress="keypress()"><input type="hidden" name="xx" ></font></p>                            
      ...
      <font size="2"><input type="button" value="浏  览" name="B1" OnClick ="b1_Click()"></font></p>                               
      </form>
    </td>
  </tr>
</table>
