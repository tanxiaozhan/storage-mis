...
<body>
  ...
  <TR> 
     <TH width=40>详情</TH>
     <TH width="70"><a href="InStore_Browse_All_Frame.asp?Sort1=BillNo"><font color="#ffffff">进仓单号</font></a></TH> 
     <TH width="280"><a href="InStore_Browse_All_Frame.asp?Sort1=ClientID"><font color="#ffffff">存货货主</font></a></TH> 
     <TH width="70"><a href="InStore_Browse_All_Frame.asp?Sort1=ContractID"><font color="#ffffff">合同号</font></a></TH> 
     <TH width="110"><a href="InStore_Browse_All_Frame.asp?Sort1=goodsName"><font color="#ffffff">品 名</font></a></TH>                                                                          
     <TH width="110"><a href="InStore_Browse_All_Frame.asp?Sort1=Specs"><font color="#ffffff">规 格</font></a></TH>                                                                          
     <TH width="40"><a href="InStore_Browse_All_Frame.asp?Sort1=Allnumber"><font color="#ffffff">捆 数</font></a></TH>                                                                                        
     <TH width="40"><a href="InStore_Browse_All_Frame.asp?Sort1=Remainnumber"><font color="#ffffff">结余捆数</font></a></TH>                                                                                        
     <TH width="60"><a href="InStore_Browse_All_Frame.asp?Sort1=PackNumber"><font color="#ffffff">件 数</font></a></TH>                                                                                        
     <TH width="60"><a href="InStore_Browse_All_Frame.asp?Sort1=RemainPack"><font color="#ffffff">结余件数</font></a></TH>                                                                                        
     <TH width="120"><a href="InStore_Browse_All_Frame.asp?Sort1=weight"><font color="#ffffff">总重(吨)</font></a></TH>                                                                                        
     <TH width="120"><a href="InStore_Browse_All_Frame.asp?Sort1=Remainweight"><font color="#ffffff">结余总重(吨)</font></a></TH>                                                                                        
     <TH width=110><a href="InStore_Browse_All_Frame.asp?Sort1=date1"><font color="#ffffff">日期</font></a></TH>
     <TH width=100><font color="#ffffff">记录号</font></TH>
...
<%  
  ...
  if session("varBillNo") <> "" then
		  sql ="Select ClientName,RecNo,BillNo,ClientID,ContractID,GoodsName,Specs,AllNumber,RemainNumber,PackNumber,RemainPack,Weight,RemainWeight,date1 " & _
    	   	   "from ClientInfo,InStore " & _
  	   		   "where ClientInfo.ID=InStore.ClientID and BillNo='" & session("varBillNo") & "'"  
  else
  		if session("varContractID") <> "" then
  			  sql ="Select ClientName,RecNo,BillNo,ClientID,ContractID,GoodsName,Specs,AllNumber,RemainNumber,PackNumber,RemainPack,Weight,RemainWeight,date1 " & _
			       "from ClientInfo,InStore " & _
			  	   "where ClientInfo.ID=InStore.ClientID and ContractID='" & session("varContractID") & "'" 
		else
			  ...
			  if request("Sort1") ="" then
			  	    ...
			  	    sql =sql & "order by InStore.ClientID asc, InStore.Date1 asc,InStore.time1 asc"
			  else
  ...
  while not rs.eof
      ...
      Response.Write "<td bgcolor='#ffffff'><A HREF='InStore_Edit.asp?RecNo=" & rs("RecNo") & "&ContractID=" & rs("ContractID") & "&ClientID=" & rs("ClientID") & "'>" & _
                     "<p align='center'><img border='0' src='image/magnifier.gif' width='16' height='16'></p></A></TD>" & _
                     "<TD bgcolor='#e4e8ef'>" & rs("BillNo") & "</td>" & _
                     "<td bgcolor='#ffffff'>" & rs("ClientName") & "</td>" & _ 
                     "<td bgcolor='#e4e8ef'>" & rs("ContractID") & "</td>" & _
                     "<td bgcolor='#ffffff'>" & rs("GoodsName") & "</td>" & _
                     "<td bgcolor='#e4e8ef'>" & rs("Specs") & "</td>" & _ 
                     ...
                     "<td bgcolor='#e4e8ef'align='right'>" & gs(cdbl(rs("RemainWeight")),4) & "</td>" & _
                     "<td bgcolor='#ffffff'>" & rs("Date1") & "</td>" & _
                     "<td bgcolor='#e4e8ef'>" & rs("recno") & "</td></TR>"
