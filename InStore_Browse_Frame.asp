...
<body>
  ...
  <TR> 
     <TH width=40>详情</TH>
     <TH width="70"><a href="InStore_Browse_Frame.asp?Sort1=BillNo"><font color="#ffffff">进仓单号</font></a></TH> 
     <TH width="70"><a href="InStore_Browse_Frame.asp?Sort1=ContractID"><font color="#ffffff">合同号</font></a></TH> 
     <TH width="110"><a href="InStore_Browse_Frame.asp?Sort1=GoodsName"><font color="#ffffff">品 名</font></a></TH>                                                                          
     <TH width="110"><a href="InStore_Browse_Frame.asp?Sort1=Specs"><font color="#ffffff">规 格</font></a></TH>                                                                          
     <TH width="40"><a href="InStore_Browse_Frame.asp?Sort1=AllNumber"><font color="#ffffff">捆 数</font></a></TH>                                                                                        
     <TH width="40"><a href="InStore_Browse_Frame.asp?Sort1=RemainNumber"><font color="#ffffff">结余捆数</font></a></TH>  
     <TH width="60"><a href="InStore_Browse_Frame.asp?Sort1=PackNumber"><font color="#ffffff">件 数</font></a></TH>                                                                                        
     <TH width="60"><a href="InStore_Browse_Frame.asp?Sort1=RemainPack"><font color="#ffffff">结余件数</font></a></TH>                                                                                        
     <TH width="100"><a href="InStore_Browse_Frame.asp?Sort1=PackWeight"><font color="#ffffff">每件重(公斤)</font></a></TH>                                                                                        
     <TH width="120"><a href="InStore_Browse_Frame.asp?Sort1=Weight"><font color="#ffffff">总重(吨)</font></a></TH>                                                                                        
     <TH width="120"><a href="InStore_Browse_Frame.asp?Sort1=RemainWeight"><font color="#ffffff">结余总重(吨)</font></a></TH>                                                                                        
     <TH width=110><a href="InStore_Browse_Frame.asp?Sort1=Date1"><font color="#ffffff">日期</font></a></TH>
...
<%  
  ...
  while not rs.eof
      ...
      Response.Write "<td bgcolor='#e4e8ef'><A HREF='InStore_Edit.asp?RecNo=" & rs("RecNo") & "&ContractID=" & rs("ContractID") & "&ClientID=" & rs("ClientID") & "'>" & _
                     "<p align='center'><img border='0' src='image/magnifier.gif' width='16' height='16'></p></A></TD>" & _
				     "<td bgcolor='#ffffff'>" & rs("BillNo") & "</td>" & _
                     ...
                     "<td bgcolor='#ffffff'align='right'>" & rs("PackWeight") & "</td>" & _
                     "<td bgcolor='#e4e8ef'align='right'>" & gs(cdbl(rs("Weight")),4) & "</td>" & _ 
                     "<td bgcolor='#ffffff'align='right'>" & gs(cdbl(rs("RemainWeight")),4) & "</td>" & _ 
                     "<td bgcolor='#e4e8ef'>" & rs("Date1") & "</td>" & _
                     "<td bgcolor='#ffffff'>" & rs("recno") & "</td></TR>"
