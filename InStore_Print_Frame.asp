...
<body>
  ...
  <TR> 
     <TH width=40>打印</TH>
     <TH width="70"><a href="InStore_Print_Frame.asp?Sort1=BillNo"><font color="#ffffff">单 号</font></a></TH> 
     <TH width="70"><a href="InStore_Print_Frame.asp?Sort1=ContractID"><font color="#ffffff">合同号</font></a></TH> 
     <TH width="110"><a href="InStore_Print_Frame.asp?Sort1=GoodsName"><font color="#ffffff">品名</font></a></TH>                                                                          
     <TH width="110"><a href="InStore_Print_Frame.asp?Sort1=Specs"><font color="#ffffff">规格</font></a></TH>                                                                          
     <TH width="40"><a href="InStore_Print_Frame.asp?Sort1=AllNumber"><font color="#ffffff">捆数</font></a></TH>                                                                                        
     <TH width="60"><a href="InStore_Print_Frame.asp?Sort1=PackNumber"><font color="#ffffff">件数</font></a></TH>                                                                                        
     <TH width="100"><a href="InStore_Print_Frame.asp?Sort1=PackWeight"><font color="#ffffff">件重(公斤)</font></a></TH>                                                                                        
     <TH width="120"><a href="InStore_Print_Frame.asp?Sort1=Weight"><font color="#ffffff">总重(吨)</font></a></TH>                                                                                        
     <TH width=110><a href="InStore_Print_Frame.asp?Sort1=Date1"><font color="#ffffff">日期</font></a></TH>
  </TR> 
...
<%  
  ...
  if session("varDisplayZero") = "ON" then
  	  ...
  	  sql1 = "and RemainWeight > 0 and date1 >= #" & StartDate & "#" & " and date1 <= #" & EndDate & "#" 
  end if
 ...
 ' sql ="Select * from InStore where RemainWeight > 0 AND ClientID = " & Session("varClientID")  & " " & sql1   '显示选择客户的仓储
  ...
  if request("Sort1") ="" then
  		session("SortKey")="BillNo"
  		session("SortDirect")="asc"
  	    sql =sql & "order by billno asc,date1 asc,time1 asc "
 else
  ...
  while not rs.eof
      ...
      Response.Write "<td bgcolor='#ffffff'><A HREF='Print_InStore_Table_Grid.asp?BillNo=" & rs("BillNo") & "&ClientID=" & rs("ClientID") & "&PrintDate=" & rs("Date1") & "'>" & _
                     ...
                     "<td bgcolor='#e4e8ef' align='right'>" & rs("PackWeight") & "</td>" & _
