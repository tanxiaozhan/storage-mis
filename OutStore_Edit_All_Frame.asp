...
<body>
  ...
  <TR> 
     <TH width=60>编辑</TH>
     <TH width="280"><a href="OutStore_Edit_All_Frame.asp?Sort1=outstore.ClientID"><font color="#ffffff">存货货主</font></a></TH> 
     <TH width="70"><a href="OutStore_Edit_All_Frame.asp?Sort1=outstore.BillNo"><font color="#ffffff">出仓单号</font></a></TH> 
     <TH width="70"><a href="OutStore_Edit_All_Frame.asp?Sort1=instore.billno"><font color="#ffffff">进仓单号</font></a></TH> 
     <TH width="150"><a href="OutStore_Edit_All_Frame.asp?Sort1=outstore.ContractID"><font color="#ffffff">合同号</font></a></TH> 
     <TH width="110"><a href="OutStore_Edit_All_Frame.asp?Sort1=outstore.GoodsName"><font color="#ffffff">品 名</font></a></TH>                                                                          
     <TH width="90"><a href="OutStore_Edit_All_Frame.asp?Sort1=outstore.Specs"><font color="#ffffff">规 格</font></a></TH>                                                                          
     <TH width="60"><a href="OutStore_Edit_All_Frame.asp?Sort1=outstore.Number1"><font color="#ffffff">捆 数</font></a></TH>                                                                                          
     <TH width="80"><a href="OutStore_Edit_All_Frame.asp?Sort1=outstore.Pack1"><font color="#ffffff">件 数</font></a></TH>    
     <TH width="110"><a href="OutStore_Edit_All_Frame.asp?Sort1=outstore.Weight"><font color="#ffffff">总重(吨)</font></a></TH>                                                                                          
     <TH width="50"><a href="OutStore_Edit_All_Frame.asp?Sort1=outstore.place1"><font color="#ffffff">仓 位</font></a></TH> 
     <TH width=100><a href="OutStore_Edit_All_Frame.asp?Sort1=outstore.date2"><font color="#ffffff">日 期</font></a></TH>
  </TR> 
...
<%  
  ...
  set rs=server.createobject("adodb.recordset")
   ...
   if session("varBillNo") <> "" then
		  sql ="Select ClientName,outstore.RecNo,outstore.billno as outbillno,instore.billno as inbillno,Pickupid,outstore.contractid,outstore.goodsname,outstore.specs,number1,pack1,outstore.weight,outstore.place1,outstore.date2 " & _
			   "from ClientInfo, OutStore, instore " & _
			   "where ClientInfo.ID=OutStore.ClientID and outstore.instorerecno=instore.recno and outstore.BillNo='" & session("varBillNo") & "' "  
  	   		   
  else
  		if session("varContractID") <> "" then
			  sql ="Select ClientName,outstore.RecNo,outstore.billno as outbillno,instore.billno as inbillno,Pickupid,outstore.contractid,outstore.goodsname,outstore.specs,number1,pack1,outstore.weight,outstore.place1,outstore.date2 " & _
				   "from ClientInfo, OutStore, instore " & _
				   "where ClientInfo.ID=OutStore.ClientID and outstore.instorerecno=instore.recno and ContractID='" & session("varContractID") & "' "  & _
				   "order by date2 asc"
		else

			  sql ="Select ClientName,outstore.RecNo,outstore.billno as outbillno,instore.billno as inbillno,Pickupid,outstore.contractid,outstore.goodsname,outstore.specs,number1,pack1,outstore.weight,outstore.place1,outstore.date2 " & _
				   "from ClientInfo, OutStore,instore " & _
				   "where ClientInfo.ID=OutStore.ClientID and outstore.instorerecno=instore.recno  " & sql1
  
			  if request("Sort1") ="" then
			  		session("SortKey")="outstore.ClientID"
			  		session("SortDirect")="asc"
			  	    sql =sql & 	   "order by outstore.clientid asc, outstore.Date2 asc,outstore.time1 asc"
			  else
  ...
  while not rs.eof
      ...
      Response.Write "<td bgcolor='#e4e8ef'><A HREF='OutStore_Edit_Fill.asp?RecNo=" & rs("RecNo") & "'>" & _
                     ...
                     "<TD bgcolor='#ffffff' align='center'>" & rs("ClientName") & "</td>" & _
                     "<TD bgcolor='#e4e8ef' align='center'>" & rs("outbillno") & "</td>" & _
                     "<td bgcolor='#ffffff' align='center'>" & rs("inbillno") & "</td>" & _
                     "<td bgcolor='#e4e8ef' align='center'>" & rs("ContractID") & "</td>" & _
                     "<td bgcolor='#ffffff' align='center'>" & rs("GoodsName") & "</td>" & _
                     "<td bgcolor='#e4e8ef' align='center'>" & rs("Specs") & "</td>" & _
                     "<td bgcolor='#ffffff' align='right'>" & rs("Number1") & "</TD>" & _
                     "<td bgcolor='#e4e8ef' align='right'>" & rs("Pack1") & "</td>" & _
                     "<td bgcolor='#ffffff' align='right'>" & gs(cdbl(rs("Weight")),4) & "</td>" & _
                     "<td bgcolor='#e4e8ef' align='center'>" & rs("Place1") & _
                     "<td bgcolor='#ffffff' align='center'>" & rs("Date2") & "</td></TR>"
