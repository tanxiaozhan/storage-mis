...
<body>
  ...
  <TR> 
     <TH width=40>打印</TH>
     <TH width="250"><a href="OutStore_Print_All_Frame.asp?Sort1=ClientID"><font color="#ffffff">存货货主</font></a></TH> 
     <TH width="100"><a href="OutStore_Print_All_Frame.asp?Sort1=BillNo"><font color="#ffffff">出仓单号</font></a></TH> 
     <TH width="110"><a href="OutStore_Print_All_Frame.asp?Sort1=PickUpID"><font color="#ffffff">提单号</font></a></TH>                                                                          
     <TH width="190"><a href="OutStore_Print_All_Frame.asp?Sort1=Crop"><font color="#ffffff">提货单位</font></a></TH>                                                                          
     <TH width="110"><a href="OutStore_Print_All_Frame.asp?Sort1=GoodsName"><font color="#ffffff">品 名</font></a></TH>                                                                          
     <TH width="110"><a href="OutStore_Print_All_Frame.asp?Sort1=Specs"><font color="#ffffff">规 格</font></a></TH>                                                                          
     <TH width="60"><a href="OutStore_Print_All_Frame.asp?Sort1=Number1"><font color="#ffffff">捆 数</font></a></TH>                                                                                          
     <TH width="80"><a href="OutStore_Print_All_Frame.asp?Sort1=Pack1"><font color="#ffffff">件　数</font></a></TH>    
     <TH width="100"><a href="OutStore_Print_All_Frame.asp?Sort1=Weight"><font color="#ffffff">总重(吨)</font></a></TH>                                                                                          
     <TH width="50"><a href="OutStore_Print_All_Frame.asp?Sort1=Place1"><font color="#ffffff">仓　位</font></a></TH> 
     <TH width=110><a href="OutStore_Print_All_Frame.asp?Sort1=Date2"><font color="#ffffff">日　期</font></a></TH>
  </TR> 
...
<%  
 ...
 set rs=server.createobject("adodb.recordset")
  ...
  if session("varBillNo") <> "" then
	  sql ="Select ClientName,ClientID,BillNo,PickupID,Crop,GoodsName,Specs,Number1,Pack1,Weight,Place1,Date2 " & _
    	   "from ClientInfo,OutStore " & _
	       "where ClientInfo.ID=OutStore.ClientID and BillNo='" & session("varBillNo") & "'" 
  
  else
  		if session("varContractID") <> "" then
			  sql ="Select ClientName,ClientID,BillNo,PickupID,Crop,GoodsName,Specs,Number1,Pack1,Weight,Place1,Date2 " & _
			       "from ClientInfo,OutStore " & _
			       "where ClientInfo.ID=OutStore.ClientID and ContractID='" & session("varContractID") & "'"
  		
  		else
  		
			 sql ="Select ClientName,ClientID,BillNo,PickupID,Crop,GoodsName,Specs,Number1,Pack1,Weight,Place1,Date2 " & _
			       "from ClientInfo,OutStore " & _
			       "where ClientInfo.ID=OutStore.ClientID  " & sql1
       

			  if request("Sort1") ="" then
			  		session("SortKey")="ClientID"
			  		session("SortDirect")="asc"
			  	    sql =sql & "order by ClientId asc, Date2 asc,time1 asc"
			 else
  ...
  while not rs.eof
      ...
      Response.Write "<td bgcolor='#e4e8ef'><A HREF='Print_OutStore_Table_Grid.asp?ClientID=" & rs("ClientID") & "&BillNo=" & rs("BillNo") & "&PrintDate=" & rs("Date2") &  "'>" & _
                     ...
                     "<td bgcolor='#ffffff' align='center'>" & rs("PickupID") & "</td>" & _
                     "<td bgcolor='#e4e8ef' align='center'>" & rs("Crop") & "</td>" & _
                     ...
                     "<td bgcolor='#e4e8ef'>" & rs("Place1") & "</td>" & _
                     "<td bgcolor='#ffffff'>" & rs("Date2") & "</td></TR>"
