...
<%
 if request("jy")="查看结存" and trim(request("ye"))<>"" and trim(request("mon"))<>"" and trim(request("ri"))<>"" then
     ...
     response.write "<p>"  
     response.write "<table width='1000'><tr><td valign='middle' align='center'><b><font size='3'>总结存情况(" & tmpday1 & ")</font></b></td></tr></table>" 
    
     response.write "<table border='1' width='1000' bordercolor='#000000'style='border-collapse: collapse' cellspacing='0' cellpadding='0'>"

      
     response.write "<tr><td valign='middle' align='center'>序号</td><td valign='middle' align='center'>货主名称</td><td valign='middle' align='center'><a href='cremainty1.asp?jy=查看结存&na=ContractID&ye=" & trim(request("ye")) & "&mon=" & trim(request("mon")) & "&ri=" & trim(request("ri")) & "'>合同号</a></td><td valign='middle' align='center'><a href='cremainty1.asp?jy=查看结存&na=GoodsName&ye=" & trim(request("ye")) & "&mon=" & trim(request("mon")) & "&ri=" & trim(request("ri")) & "'>产品名</a></td><td valign='middle' align='center'><a href='cremainty1.asp?jy=查看结存&na=Specs&ye=" & trim(request("ye")) & "&mon=" & trim(request("mon")) & "&ri=" & trim(request("ri")) & "'>规格</a></td>" & _
                    "<td valign='middle' align='center'><a href='cremainty1.asp?jy=查看结存&na=remainnumber&ye=" & trim(request("ye")) & "&mon=" & trim(request("mon")) & "&ri=" & trim(request("ri")) & "'>目前结存捆数/件数</a></td><td valign='middle' align='center'><a href='cremainty1.asp?jy=查看结存&na=remainweight&ye=" & trim(request("ye")) & "&mon=" & trim(request("mon")) & "&ri=" & trim(request("ri")) & "'>目前结存吨数</a></td><td valign='middle' align='center'><a href='cremainty1.asp?jy=查看结存&na=date1&ye=" & trim(request("ye")) & "&mon=" & trim(request("mon")) & "&ri=" & trim(request("ri")) & "'>进货时间</a></td><td valign='middle' align='center'>备注</td></tr>"
     ...
     do while not rs.eof        
		...
		if ktv=colsed then
		   ...
		   response.write "<table width='1000'><tr><td valign='middle' align='center'><b><font size='3'>总结存情况</font></b></td></tr></table>" 
     ...
     response.write "<tr><td valign='middle' align='center' colspan='4'>&nbsp;&nbsp;合&nbsp;&nbsp;计&nbsp;&nbsp;</td><td valign='middle' align='right'>" & gs(zremainjian,4) & "</td>" & _
     ...
     response.write "<table width='900'><tr><td valign='middle' align='center'>填表：_________________&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" & "仓库(盖章)：_________________</td></tr></table>"  
