  ...
  <TR>
    <TD vAlign=top width=249 height="318" rowspan="2">
      <TABLE align=right border=0 cellPadding=4 cellSpacing=4 height=270 width=140>
        ...
        <TR bgColor=#339966>
          <TD width="122">
            <DIV align=center><b><A href="fast_outstore.htm"><font color="#ffffff" size="2">帮&nbsp;                                       
              助</font></A></b></DIV>
		  </TD>
		</TR>
	  </TABLE>
    ...
    <td valign="top" height="30" width="1000">     
      <form method="POST" action="OutStore.asp" name = "form1">
       ...
       <%
			...
			rs.open "select * from ClientInfo where ClientName='合昌国际贸易(深圳)有限公司' order by ClientName asc", conn, 1, 1	
		%>
