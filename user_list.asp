...
<%
 ...
 %>
  ...
  <TR> 
     <TH width="150"><font color="#ffffff">用  户</font></TH> 
     <TH width="150"><font color="#ffffff">密  码</font></TH>                                                                         
     <TH width="150"><font color="#ffffff">权  限</font></TH>                                                                                        
     <TH width=30>&nbsp;&nbsp;&nbsp;&nbsp;</TH>
  </TR> 
...
<%
  ...
  while not rs.eof
      ...
      Response.Write "<TD bgcolor='#e4e8ef'>" & rs("user") & "</td><td bgcolor='#ffffff'>" & jiemi(rs("pwd")) & "</td><td bgcolor='#e4e8ef'>" & rs("Right") & _
                     "</td><td bgcolor='#e4e8ef'><A HREF='usersc.asp?usern=" & rs("user") & "'>删除</A></TD></TR>"
